...
# # In-memory cache to store previous SMILES predictions
# prediction_cache = {}
...
#             print(f"✅ Using cached result for SMILES: {smiles}")  # Debug log
#             return jsonify({
#                 "smiles": smiles,
...
#         print(f"🔹 New prediction stored in cache for SMILES: {smiles}")  # Debug log
